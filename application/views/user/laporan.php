...
<body>
    ...
    <h3 class="m-fix text-right" style="margin-top:40px">JURNAL UMUM</h3>
    <table class="mb-fix table-striped" style="text-transform: uppercase;">
        <thead>
            <tr class="text-center font-bold" style="font-size: 10pt;">
                <th width="5">No.</th>
        ...
        ?>
                <tr style="font-size: 8pt">
                    ...
                    <td class="text-left"><?= $row->nama_reff ?><br/><small><i><?= $row->keterangan ?></i></small></td>
