  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--7">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center">
                      ...
                      <?= form_button(['type'=>'submit','content'=>'Edit','class'=>'btn btn-warning mr-3 btn-sm']) ?>
                      <?= form_close() ?>
                      ...
                      <?= form_close() ?>&nbsp;&nbsp;
                      <button class="btn btn-primary btn-sm" data="<?= $row->id_transaksi; ?>" id="lampiranJurnal">Lampiran</button>
                    </td>       
                  </tr>
                  <?php 
                    endif;
                  ...
                  <tr>
                    ...
                    <td class="text-right"><?= $row->nama_reff ?><br/>
                    <small><i><?= $row->keterangan ?></i></small></td>
                    <td><?= $row->no_reff ?></td>
                    <td>
                      Rp. 0
                    </td>
                    ...
                    <td class="d-flex justify-content-center">
                      <?= form_open('jurnal_umum/edit_form','',['id'=>$row->id_transaksi]) ?>
                      <?= form_button(['type'=>'submit','content'=>'Edit','class'=>'btn btn-warning btn-sm mr-3']) ?>
                      <?= form_close() ?>
      ...
      <div class="modal fade" id="gambarLampiran">
        <div class="zoom-efect">
          <div class="modal-dialog lampiran-gambar kotak">
