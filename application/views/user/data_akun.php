            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col-12 my-3">
                  <a href="<?= base_url('data_akun/tambah') ?>" class="btn btn-primary btn-sm mt-2"><i class="fas fa-plus"></i> Tambah Akun</a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center">
                        <a href="<?= base_url('data_akun/edit/'.$row->no_reff) ?>" class="btn btn-warning btn-sm mb-4">Edit</a>
