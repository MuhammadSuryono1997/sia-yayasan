                ...
                <div class="col-12 my-3 form-1">
                  ...
                  <div class="row mb-4">
                    <div class="col">
                      ...
                      <textarea class="form-control keterangan-transaksi" name="keterangan-transaksi" id="keteranganTransaksi"><?= $data->keterangan ?></textarea>
                      <?= form_error('keterangan') ?>
                    </div>
                    <div class="col">
                      <label for="lampiran">Lampiran</label>
                      <input type="file" name="lampiran" class="form-control lampiran" id="lampiran">
                      <small><i>File yang diperbolehkan (gif/jpg/jpeg/png) dengan ukuran maksimal 1 Mb</i></small>
                    </div>
                  </div>
