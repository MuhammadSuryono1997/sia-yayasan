        ...
        <div class="col mb-5 mb-xl-0">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col my-3">
                  <a href="<?= base_url('jurnal_umum/tambah') ?>" class="btn btn-primary btn-sm mt-2"><i class="fas fa-plus"></i> Tambah Jurnal</a>
                </div>
                <div class="col my-3">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td scope="col">
                        ...
                        <?= form_button(['type'=>'submit','content'=>'Lihat Jurnal','class'=>'btn btn-success btn-sm mr-3']) ?>
                        <?= form_close() ?>
                    </td>
                  </tr>
                  <?php
