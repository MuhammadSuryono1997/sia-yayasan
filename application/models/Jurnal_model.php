...
class Jurnal_model extends CI_Model{
    ...
    public function getJurnalByNoReffMonthYear($noReff,$bulan,$tahun){
        return $this->db->select('transaksi.id_transaksi,transaksi.keterangan,transaksi.tgl_transaksi,akun.nama_reff,transaksi.no_reff,transaksi.jenis_saldo,transaksi.saldo,transaksi.tgl_input')
                    ->from($this->table)            
                    ->where('transaksi.no_reff',$noReff)
